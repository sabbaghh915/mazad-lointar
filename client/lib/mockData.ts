import { AuctionItem, User, ClassifiedAd } from "@shared/api";
...
export const mockAuctions: AuctionItem[] = [
  ...
  // السويداء
  {
    ...
    description:
      "شقة دوبلكس فاخرة، طابقين، 4 غرف نوم، 3 حمامات، تراس علوي، تشطيب حديث، موقع هادئ",
    descriptionEn:
  ...
  },
  {
    ...
    description:
      "سيارة نيسان سنترا موديل 2020، اقتصادية في الوقود، لون رمادي، قماش، أوتوماتيك، صيانة دورية",
    descriptionEn:
  ...
  // ا��رقة
  {
    ...
    description:
      "محل تجاري في وسط المدينة، واجهة مزدوجة، مساحة 80 متر مربع، موقع حيوي، مناسب لجميع الأنشطة",
    descriptionEn:
  ...
  {
    id: "20",
    title: "معمل صغير في إدلب - الفوعة",
  ...
  },
  {
    ...
    description:
      "شقة حديثة في مدينة الشهباء الجديدة، 2 غرف نوم، صالون، مطبخ، بلكونة، تشطيب فاخر، موقع حيوي",
    descriptionEn:
...
export const mockClassifiedAds: ClassifiedAd[] = [
  ...
  },
  {
    ...
    description:
      "سيارة هيونداي إلنترا موديل 2019، اقتصادية في الوقود، حالة ممتازة، جميع القطع أصلية، مكيف ب��رد.",
    category: "cars",
    images: [
      "https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=800&q=80",
    ],
